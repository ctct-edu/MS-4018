...
3. Copilotペインの左下の**編集**という項目を展開し、**チャットのみ**に変更します。
...
1. 先ほど変更したCopilotペインの**チャットのみ**と書かれている項目を展開し、**編集を許可する**に変更します。
...
1. ExcelのCopilotペインからによって生成された応答をコピーします。  
