...
2. メール本文欄もしくは右上の**Copilotアイコン**をクリックします。入力欄に以下のプロンプトを入力します。
...
1. 右側のCopilotペインから入力してください。 **コンテンツの追加**から**Copilotで編集**が選択された状態でCopilotが開きます。
