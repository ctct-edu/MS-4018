...
2. 右上の**Copilotアイコン**をクリックします。入力欄に以下のプロンプトを入力します。

   ```
   社外向け・丁寧なトーンで、顧客である佐藤美咲様に、サポートチケットの現在の状況を確認する新しいメールを日本語で下書きしてください。その際の宛先メールアドレスを架空のアドレスで入れてください。
   ```

3. 結果を確認し、どのようなメールが生成されるかを観察します。生成された結果は
...
7. 以下のプロンプトを試します：
   ...
   ```
   顧客である佐藤美咲様に、サポートチケットの状況について新しいメールを下書きしてください。問題はTier 2サポートにエスカレートされ、48時間以内に解決が期待されています。
   ```
...
9. 以下の完成されたプロンプトを試します：
   ...
   ```
   顧客である佐藤美咲様に、サポートチケットの状況について新しいメールを下書きしてください。問題はTier 2サポートにエスカレートされ、48時間以内に解決が期待されています。メールは専門的で技術的でありながら、共感を持って書かれたものにしてください。
   ```
...
1. 右側のCopilotペインを開き、**Copilotで編集**をオフ（プロンプト欄にあるアイコンを×で消す）にします。
...
1. 右側のCopilotペインを開きます。 **Copilotで編集**をオン（+アイコンから選択）にします。
